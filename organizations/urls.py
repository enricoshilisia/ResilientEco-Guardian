...
urlpatterns = [
    ...
    # ── Shared global views ───────────────────────────────────────────
    path('org/<uuid:org_id>/members/',  views.org_members,              name='org_members'),
    path('org/<uuid:org_id>/profile/',  views.org_profile,              name='org_profile'),
    path('org/<uuid:org_id>/settings/', views.org_settings,             name='org_settings'),

    # ── Convenience smart redirect ────────────────────────────────────
    # NOTE: keep this LAST so specific routes above match first
    path('org/<uuid:org_id>/',          views.smart_dashboard_redirect, name='org_dashboard'),
]